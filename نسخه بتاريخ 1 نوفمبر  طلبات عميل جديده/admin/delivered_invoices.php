...
// ";
// build select (use COALESCE to treat updated_at as delivery date when present, otherwise created_at)
// build select (use COALESCE so delivery_date is updated_at if exists, otherwise created_at)
$sql_select_base = "
    SELECT
        i.id,
        i.invoice_group,
