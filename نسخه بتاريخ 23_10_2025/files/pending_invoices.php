    ...
    <!-- زر فتح المودال (ضعه بجانب زر عرض الفاتورة أو داخل تفاصيل الفاتورة) -->

    <!-- مودال إرجاع -->
    <!-- Modal (you provided) -->
    <div id="returnInvoiceModal" class="modal-backdrop" style="display:none;">
        <div class="mymodal">
            <h3>تأكيد إرجاع الأصناف</h3>
            <p id="ri_invoice_info">
                هل تريد فعلاً إرجاع أصناف من الفاتورة رقم
                <strong id="ri_invoice_id"></strong>؟
            </p>

            <!-- جدول البنود -->
            <div class="custom-table-wrapper" style="margin-top:10px;">
                <table class="custom-table" id="ri_items_table">
                    <thead>
                        <tr>
                            <th style="text-align:right;">اسم المنتج</th>
                            <th style="text-align:right;">الكمية الأصلية</th>
                            <th style="text-align:right;">كمية للإرجاع</th>
                        </tr>
                    </thead>
                    <tbody>
            ...
            <!-- الملاحظة -->
            <label for="ri_reason" style="display:block;margin-top:10px;">ملاحظة (اختياري):</label>
            <textarea id="ri_reason" rows="2" style="width:100%;" placeholder="اكتب ملاحظة عن الإرجاع"></textarea>

            <!-- الأزرار -->
            <div style="margin-top:12px; text-align:right;">
                <button id="ri_close_btn" class="btn btn-warning" style="margin-right:8px;">إغلاق</button>
                <button id="ri_confirm_btn" class="btn btn-danger">تأكيد الإرجاع</button>
            </div>

            <div id="ri_feedback" style="margin-top:10px;color:#d00;display:none;"></div>
        </div>
    </div>
    ...
    .modal-content { background:#fff; padding:18px; width:900px; max-width:95%; border-radius:8px; box-shadow:0 8px 30px rgba(0,0,0,0.2); }
