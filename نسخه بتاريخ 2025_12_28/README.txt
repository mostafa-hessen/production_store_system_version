...
1-  صفحه الفاتوره 
** تغيير زر نقدي ثابت
**زر البيع القطاعي _ دعم البيع قطاعي وجمله بندين منفصلين
** اجمالي الربح يظهر في شكل علي اليمين 
** تغيير شكل زر المؤجل والمدفوع 
** تعديل جزء الطباعه حتي يشمل فكره الخصم
** اعاده تصميم صفحه الفاتوره 
** اضافه خصم البند 
** دعم الباركود
** دعم الدفع الجزئي
** دعم الدفع الكلي وتقسيمه
** دعم الدفع بالمحفظه 
...
3- العملاء
** اعاده تصميم صفحه العملاء 
-- تظهر فيها الديون الكليه 
--- اجمالي علي العميل وليه
--- دعم عرض متعدد لشكل التقسم جدول وكاردز
--- تطوير البحث بالصفحه


4- صفحه تفاصيل العميل (ميزه جديده)
-- تفاصيل العميل
-- ميزه ديون العميل والمحفظه
-- سداد متعدد 
-- انشاء شغلانه
-- محفظه ايداع سحب 
-- حركه العميل
-- حركه المحفظه
-- مرتجعات انشاء فواتير مرتجعات امكانيه رد مبلغ نقدي او 
-- بحث متقدم + فلاتر متقدم 
-- كشف حساب ---> حساب الاستاذ
__ احصائيات عامه للفواتير


5- اعاده تصميم ال ui 
-- اعاده تصميم ال sidbar --> دعم البحث والقوائم المنسدله 
-- دعم سهوله التنقل في الشريط العلوي


6- النسخ الاحتياظي مهم جدا
-- ميزه النسخ الاحتياطي --> جوجل درايف - علي الجهاز
-- ميزه النسخ الاحتياطي التلقائي بعد ساعه معينه 

7- ميزه الاشعارات (ميزه جديده) 
-- كل يوم بيحيلك اشعار بعد النسخ التلقائي
-- امكانيه تحديد كمقروء او تحديد الكل كمقروء
